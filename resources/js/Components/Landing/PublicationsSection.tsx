        ...
        <section id="publications" className="py-20 md:py-28 bg-[#FBFDFB] dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-800 transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {activePublications.length > 0 ? (
                    ...
                    <EmptyState
                        title={isIndonesian ? 'Tidak ada data publikasi ilmiah ditemukan' : 'No academic publications found'}
                        description={isIndonesian ? 'Publikasi dan artikel ilmiah belum tersedia di database.' : 'Academic papers and publications are not available in the database.'}
                    />
                )}
            </div>
        </section>
