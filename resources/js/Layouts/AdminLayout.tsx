...
export default function AdminLayout({
    ...
    // Navigation Menu Structure tailored for CoE STAS-RG with clear, intuitive labels
    const navigationGroups: NavGroup[] = [
        {
            groupName: isEn ? "OVERVIEW" : "RINGKASAN",
            items: [
                {
                    name: isEn ? "Dashboard" : "Dashboard Utama",
                    href: "/admin",
        ...
        {
            groupName: isEn ? "RESEARCH & INNOVATION" : "RISET & PENGEMBANGAN",
            items: [
                {
                    name: isEn ? "Research Areas" : "Bidang Riset",
                    href: "/admin/domains",
                    icon: Layers,
                    active:
                        url === "/admin/domains" ||
                        url.startsWith("/admin/domains"),
                },
                {
                    name: isEn ? "Research Projects" : "Proyek Riset",
                    href: "/admin/projects",
                    icon: Briefcase,
                    active:
                        url === "/admin/projects" ||
                        url.startsWith("/admin/projects"),
                },
                {
                    name: isEn ? "Publications" : "Publikasi Ilmiah",
        ...
        },
        {
            ...
            items: [
                ...
                {
                    name: isEn ? "Partners & Network" : "Mitra Kerjasama",
                    href: "/admin/partners",
                    icon: Building2,
                    active:
                        url === "/admin/partners" ||
                ...
                {
                    name: isEn ? "Events & Workshops" : "Agenda & Acara",
                    href: "/admin/events",
                    icon: Calendar,
                    active:
                        url === "/admin/events" ||
                ...
                {
                    name: isEn ? "News & Articles" : "Berita & Artikel",
                    href: "/admin/articles",
                    icon: Newspaper,
                    active:
                        url === "/admin/articles" ||
                ...
                {
                    name: isEn ? "Inquiries & Messages" : "Pesan & Kontak Masuk",
            ...
            items: [
                {
                    ...
                    icon: Users,
                    active:
                        url === "/admin/team" || url.startsWith("/admin/team"),
                },
                {
                    name: isEn ? "System Settings" : "Pengaturan Sistem",
                    href: "/admin/settings",
    ...
    return (
        <div className="h-screen w-full bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans flex overflow-hidden transition-colors duration-200">
            <Head>
            ...
            {/* 1. Desktop Sidebar */}
            <aside
                className={`hidden lg:flex flex-col h-screen max-h-screen shrink-0 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transition-all duration-300 z-30 select-none ${
                    desktopCollapsed ? "w-20" : "w-64 xl:w-72"
                }`}
            >
                {/* Sidebar Brand Header */}
                <div
                    className={`h-16 shrink-0 px-4 border-b border-slate-200 dark:border-slate-800 flex items-center ${
                ...
                >
                    {!desktopCollapsed ? (
                        ...
                        <Link
                            href="/admin"
                            className="flex items-center justify-center p-1.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
                            title="CoE STAS-RG Dashboard"
                        >
                            <img
                                src="/stas.png"
                                alt="STAS Logo"
                ...
                {/* Navigation Menu Links (Only this part scrolls inside sidebar if list overflows) */}
                ...
                {/* Sidebar Bottom Pinned Area: User Profile Card & Collapse Toggle Button */}
                <div className="p-3 border-t border-slate-200 dark:border-slate-800 shrink-0 space-y-2 bg-white dark:bg-slate-900">
                    {/* User Profile Card */}
                    <div
                ...
                <header className="h-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between z-20">
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <button
                            ...
                            className="hidden lg:flex p-2 rounded-lg text-slate-500 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
                            title={
                                desktopCollapsed
                                    ? isEn
                                        ? "Expand sidebar"
                    ...
                    <div className="hidden md:flex items-center flex-1 max-w-xs lg:max-w-md mx-4">
                        <div className="relative w-full">
                            ...
                            <input
                                ...
                                placeholder={
                                    isEn
                                        ? "Search research projects, publications, records..."
                                        : "Cari proyek riset, publikasi ilmiah, data..."
                                }
                                    ...
                                    <div className="py-2 space-y-2 text-xs">
                                        <div className="p-2 rounded-lg bg-slate-50 dark:bg-slate-800/60">
                                            ...
                                            <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
                                                New participant registered from
                                                Indonesia Power.
                                            </div>
                                        </div>
                                        <div className="p-2 rounded-lg bg-slate-50 dark:bg-slate-800/60">
                ...
                <footer className="h-12 px-6 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs text-slate-400 dark:text-slate-500">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-slate-600 dark:text-slate-400">
                            {isEn
                                ? "CoE STAS-RG Management System"
                                : "Sistem Pengelolaan CoE STAS-RG"}
                        </span>
                        <span className="hidden sm:inline">•</span>
                        <span className="hidden sm:inline font-mono text-[11px]">
                            v2.0 Modern Minimalist
                        </span>
                    </div>
                    <div>
                        <span>
